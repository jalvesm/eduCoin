...
public class TransacaoController {
    ...
    public ResponseEntity<List<Transacao>> getTransactionsByUserId(@PathVariable UUID usuarioId) {
    return ResponseEntity.ok(transacaoService.findByUsuarioId(usuarioId));
    }
